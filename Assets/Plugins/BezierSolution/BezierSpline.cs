...
namespace BezierSolution
{
	...
	public partial class BezierSpline : MonoBehaviour, IEnumerable<BezierPoint>
	{
		...
		//what I tried
        public List<BezierPoint> endPoints = new List<BezierPoint>(); // This is not readonly because otherwise BezierWalkers' "Simulate In Editor" functionality may break after recompilation
...
;
		...
		public BezierPoint InsertNewPointAt( int index )
		{
			...
			GameObject spherePoint = GameObject.CreatePrimitive(PrimitiveType.Sphere);// done by me!!!!!!!!!!!!!!!
			spherePoint.transform.localScale = new Vector3(0.03f, 0.03f, 0.03f);
			BezierPoint point = spherePoint.AddComponent<BezierPoint>();
